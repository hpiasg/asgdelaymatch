...
public class SdfSplitMain {
    ...
    public SdfSplitMain(String name, RemoteInformation rinfo, Map<String, DelayMatchModule> modules, Technology tech) {
        this.name = name;
        this.rinfo = rinfo;
    ...
    public boolean split(int turnid, File sdfFile, File vFile, String rootModule) {
